...
exports.deleteSingleService = exports.updateSingleService = exports.getSingleService = exports.getAllUpcomingServices = exports.getAllAvailableServices = exports.createService = void 0;
const serviceServices_1 = require("./serviceServices");
const createService = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
        const result = yield serviceServices_1.ServiceServices.createService(data);
        res.status(201).json({
            status: 201,
...
const updateSingleService = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const data = req.body;
        const result = yield serviceServices_1.ServiceServices.updateSingleService(id, data);
        res.status(200).json({
            status: 200,
...
const deleteSingleService = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const result = yield serviceServices_1.ServiceServices.deleteSingleService(id);
        res.status(200).json({
            status: 200,
