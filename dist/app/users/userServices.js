...
const createAdmin = (token, user) => __awaiter(void 0, void 0, void 0, function* () {
    const email = user.email;
    if (user.role === "admin") {
        if (!token) {
            throw new apiErrors_1.default(409, "Unauthorized access");
...
const loginUser = (credentials) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.isBanned) {
        throw new apiErrors_1.default(403, `User ${credentials.email} is Banned`);
    }
    if (!isUserExist) {
