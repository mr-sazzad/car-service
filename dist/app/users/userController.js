...
exports.updateSingleUser = exports.getAllAdmins = exports.getAllUsers = exports.getSingleUser = exports.loginUser = exports.createAdmin = exports.createUser = void 0;
...
const createAdmin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const token = req.headers.authorization;
        const user = req.body;
        const result = yield userServices_1.UserServices.createAdmin(token, user);
        res.status(201).json({
            status: 201,
